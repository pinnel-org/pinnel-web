// world-atlas topojson uses numeric ISO 3166-1 codes in `id`.
// pinnel-api will return alpha-3 codes; this table bridges them.
...
// world-atlas stores `id` as either a zero-padded string or a number; normalize before lookup.
export const numericToAlpha3 = (id: string | number | undefined): string | null => {
